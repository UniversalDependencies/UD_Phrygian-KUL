...
Of the Old Phrygian subcorpus, so far only the inscriptions from Provenances Midas City (M), Diverse documents (Dd) and Outside of Phrygia (HP) are included. The readings for Dd-103, -104 and -105 are provided by Obrador-Cursach (2019), while the more recent interpretation of _Pserkeyoy_/_Pseukeyoy_ (Dd-101) and _Surgastoy_ (Dd-102) as patronymics come from Obrador-Cursach (2021).
